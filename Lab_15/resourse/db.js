...
class DB{
    constructor()
    {
        this.url = 'mongodb+srv://Tsunami:17052002yura@cluster0.hfbpr.mongodb.net/Node_15?retryWrites=true&w=majority';
        this.client = new MongoClient(this.url, {useNewUrlParser: true, useUnifiedTopology: true});
        this.client = this.client.connect().then(connection => {return connection.db("Node_15")});
